 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/logo-dark.png') }}" alt="logo icon"></a>
                ...
                <li class="nav-item">
                    <div class="search">
                        ...
                        <div class="search-box not-click">
                            <input type="text" class="not-click form-control bg-white text-dark font-weight-bold" placeholder="Search" value="" name="search">
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <div class="btn-group mb-1">
                    <button class="lang-btn not_click btn btn-sm bg-white">
                        @if (App::getLocale() == 'ar')
                            Ar
                    ...
                    <div class="lang-box lang-click">
                        <!-- This foreach to display all language -->
{{--                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)--}}
{{--                            <a class="lang-click" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">--}}
{{--                                {{ $properties['native'] }}--}}
{{--                            </a>--}}
{{--                        @endforeach--}}

                            <a class="lang-click" hreflang="{{ 'ar' }}" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}">
                                 العربية
                                  <img src="{{ URL::asset('assets/images/flags/JO.png') }}" alt="">
                            </a>
                            <a class="lang-click" hreflang="{{ 'en' }}" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">
                                English
                                <img src="{{ URL::asset('assets/images/flags/US.png') }}" alt="">
                            </a>
                    </div>
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                     ...
                     {{--################## this code for LogOut from multi users #####################--}}
                        ...
                        @endif
                                @csrf
                                <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="bx bx-log-out text-danger ti-unlock"></i>{{trans('main_trans.Logout')}}</a>
                            </form>
                            </form>
                            </form>
                            </form>
