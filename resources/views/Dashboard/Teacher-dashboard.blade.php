...
<div class="content-wrapper">
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">{{trans('teacher_trans.Dashboard_page')}}</h4>
                <h4 class="mb-3 mt- 3 text-info font-weight-bold" style="font-family: 'Cairo', sans-serif">{{trans('teacher_trans.Welcome')}}{{auth()->user()->Name}}</h4>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text font-weight-bold">{{trans('teacher_trans.No.of_student')}}</p>
                            <h4>{{$count_students}}</h4>
                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <a href="{{route('get_student.index')}}" target="_blank"><i class="far fa-eye text-success mr-1" aria-hidden="true"></i><span class="text-primary font-weight-bold">{{trans('main_trans.show_details')}}</span></a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text font-weight-bold">{{trans('teacher_trans.No.of_section')}}</p>
