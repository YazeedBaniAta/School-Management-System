...
@section('css')
    @toastr_css
@section('title')
    {{trans('main_trans.Edit_receipt_students')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    <a href="{{route('receipt_students.index')}}">{{trans('main_trans.receipt_students')}}</a> / {{trans('main_trans.Edit_receipt_students')}}"{{$receipt_student->student->name}}"
@stop
<!-- breadcrumb -->
@endsection
@section('content')
