...
@section('css')
    @toastr_css
@section('title')
    {{trans('main_trans.P_F')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    <a class="text-primary" href="{{route('Students.index')}}">{{trans('main_trans.list_students')}}</a> / {{trans('main_trans.P_F')}}"{{$student->name}}"
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('ProcessingFees.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">{{trans('main_trans.Student_Amount')}} : </label>
                        ...
                        <button class="btn btn-outline-dark font-weight-bold" type="submit">{{trans('main_trans.submit')}}</button>
                    </form>
