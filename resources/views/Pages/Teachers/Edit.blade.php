...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    <a href="{{route('Teachers.index')}}">{{ trans('main_trans.List_Teachers') }} </a> / {{ trans('main_trans.Edit_Teacher') }}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('main_trans.Name_Teachers_ar')}}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{trans('main_trans.Name_Teachers_en')}}</label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">{{trans('main_trans.Address_Teacher')}}</label>
                            ...
                            <button class="btn btn-outline-success btn-lg" type="submit">{{trans('main_trans.submit')}}</button>
                    </form>
                        </div>
                    </div>
                </div>
