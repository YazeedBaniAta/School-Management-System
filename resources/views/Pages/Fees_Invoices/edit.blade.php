...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    <a href="{{route('Fees_Invoices.index')}}">{{trans('main_trans.FeesInvoices')}}</a> / {{trans('main_trans.EditFees')}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label class="font-weight-bold text-dark" for="inputEmail4">{{trans('main_trans.name')}} : </label>
                            ...
                            <div class="form-group col">
                                <label class="font-weight-bold text-dark" for="inputEmail4">{{trans('main_trans.money')}} : </label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label class="font-weight-bold text-dark" for="inputZip">{{trans('main_trans.Fees_Type')}} :</label>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold text-dark" for="inputAddress">{{trans('main_trans.FeesDesc')}} :</label>
