...
POTENZA.searchbox = function () {
   if (jQuery('.search').exists()) {
      jQuery('.search-btn').on("click", function () {
         ...
         jQuery('.container-fluid').css('opacity','0.1');
           return false;
          });
       jQuery("html, body").on('click', function (e) {
        if (!jQuery(e.target).hasClass("not-click")) {

            jQuery('.container-fluid').css('opacity','initial');
     ...
     /*************************
      Lang
      *************************/
     POTENZA.langhbox = function () {
         if (jQuery('.btn-group').exists()) {
             jQuery('.lang-btn').on("click", function () {
                 jQuery('.btn-group').toggleClass("lang-open");
                 jQuery('.container-fluid').css('opacity','0.1');
                 return false;
             });
             jQuery("html, body").on('click', function (e) {
                 if (!jQuery(e.target).hasClass("lang-click")) {

                     jQuery('.container-fluid').css('opacity','initial');
                     jQuery('.btn-group').removeClass("lang-open");
                 }
             });
         }
     }
