...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
	    //Relation between classrooms(Grade_id) table and grades table(id)
        ...
        //Relation between sections table(Grade_id) and grades table(id)
        ...
        //Relation between sections table(Grade_id) and Classrooms table(id)
        Schema::table('sections', function(Blueprint $table) {
        ...
        //Relation between my_parents table and type_bloods,nationalities,religions tables(id)
        ...
        //Relation between Teachers table and genders,specialization tables
        Schema::table('teachers', function(Blueprint $table) {
            $table->foreign('Specialization_id')->references('id')->on('specializations')->onDelete('cascade');
            $table->foreign('Gender_id')->references('id')->on('genders')->onDelete('cascade');
        });

        //Relation between students table and genders,nationalities,type_bloods,grades,my_parents,Classrooms,sections tables
